...
InspectorModel = function(viewContainer) {
...
InspectorModel.prototype = {
  ...
  startInspectorService: function(targetDevice) {
    ...
    var inspectorPage = ThePkgCfgs.project.root + '/devtools_ex/inspector.html';
    var host = ThePkgCfgs.inspector.ip, port = ThePkgCfgs.server.port;
